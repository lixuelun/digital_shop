...
<div class="add">
	...
	<s:form action="update">	  
		...
		<s:select list="{'电脑','平板','手机','单反'}" theme="simple"  name="product.categoryid"></s:select>
		<br>
		<br>
		<s:textfield key="商品名称" name="productproName" />
		<br>
		<br>
		<s:textfield key="商品价格" name="product.setProPrice" />
		<br>
		<br>
