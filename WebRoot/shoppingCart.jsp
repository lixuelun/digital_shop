...
<html>
  ...
  <body>
  	...
  	<s:if test="#request.tip!=null">
  		<div align="center">提示：<s:property value="#request.tip" /><br></div>
  	</s:if>
  	
    <s:if test="#request.list.size()!=0">
    <div align="center"><h2><b>购物车:</b></h2></div>
  		...
  		<br><br>  	
  		<s:form action="shoppingCart" theme = "simple">
  		<div align="center"><s:submit value="支付" method="payShoppingCart" /></div>
  		</s:form>
  	</s:if>
  	<s:else>
  		<br><br>
  		<div align="center">您的购物车中空空如也，<a href="search_product.jsp">点此</a>继续选购</div>
  	</s:else>
  </body>
</html>
